        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">100% Organic Fruits</h4>
                    <h1 class="mb-3 display-3 text-primary">Fruitables: Discover <Br> the Best in Fruits</h1>
                    <div class="position-relative mx-auto">
                        <h4 class="mb-3 text-secondary" style="font-weight:400">Your go-to source for fresh, delicious, and healthy <br> fruits delivered straight to your door. </h4>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            <h5>Free Shipping</h5>
                            <p class="mb-0">Freshness Delivered, On Us!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            ...
                            <p class="mb-0">Your Payment, Our Priority</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            ...
                            <p class="mb-0">Hassle Free & Convenient</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            <h5>24/7 Support</h5>
                            <p class="mb-0">We're always there for you</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-class text-center">
                <div class="row g-4">
                    <div class="col-lg-12 text-center mb-5">
                        <h1 style="font-weight: bold; font-size: 45px">Our Organic Products</h1>
                    </div>
                            ...
                            <div class="service-item bg-primary rounded border border-primary">
                                ...
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-secondary text-center p-4 rounded">
                                        <h5 class="text-white">Quality Guaranteed</h5>
